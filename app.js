...
// ══════════════════════════════════════════════════════════
// ── طباعة البون للهاتف والطابعة الحرارية ─────────────────
// ══════════════════════════════════════════════════════════
...
<table>
<tr>
  <td class="bold">الطلب:</td>
  <td>${order.order_number}</td>
</tr>

<tr>
  <td class="bold">التاريخ:</td>
  <td>${new Date(order.created_at).toLocaleString('ar-MA')}</td>
</tr>

<tr>
  <td class="bold">الزبون:</td>
  <td>${order.customer_name || 'زبون'}</td>
</tr>

<tr>
  <td class="bold">النوع:</td>
  <td>${typeMap[order.order_type] || '-'}</td>
</tr>
</table>
...
<tr class="bold">
  ...
  <td style="text-align:left">الثمن</td>
</tr>
...
<tr>
  ...
  <td style="text-align:left">
    ${parseFloat(i.total_price || 0).toFixed(2)}
  </td>
</tr>
`).join('')}
...
<tr>
  <td>الخصم:</td>
  <td style="text-align:left">
    -${parseFloat(order.discount_amount).toFixed(2)} ${CURRENCY}
  </td>
</tr>
` : ''}
